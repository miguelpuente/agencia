    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('color', models.CharField(choices=[('BLA', 'BLANCO'), ('BPE', 'BANCO PERLA'), ('NEG', 'NEGRO'), ('ROJ', 'ROJO'), ('GRI', 'GRIS')], max_length=3)),
                ('precio', models.DecimalField(decimal_places=2, max_digits=10)),
                ('transmision', models.CharField(choices=[('M', 'MANUAL'), ('A', 'AUTOMÁTICA')], max_length=1)),
                ('estado', models.CharField(choices=[('M', 'MANUAL'), ('A', 'AUTOMÁTICA')], max_length=1)),
