    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('color', models.CharField(choices=[('BLA', 'Blanco'), ('NEG', 'Negro'), ('ROJ', 'Rojo')], default='BLA', max_length=3)),
                ('precio', models.DecimalField(decimal_places=2, max_digits=10)),
                ('transmision', models.CharField(choices=[('M', 'Manual'), ('A', 'Automática')], default='M', max_length=1)),
                ('estado', models.CharField(choices=[('D', 'Disponible'), ('R', 'Reservado'), ('V', 'Vendido')], default='D', max_length=1)),
